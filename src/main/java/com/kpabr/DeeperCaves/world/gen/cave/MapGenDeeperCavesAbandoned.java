...
public class MapGenDeeperCavesAbandoned extends MapGenBase
{
    private static final String __NOOBFID = "CL_00000393";
    ...
    protected void func_151541_a(long p_151541_1_, int p_151541_3_, int p_151541_4_, Block[] p_151541_5_, double p_151541_6_, double p_151541_8_, double p_151541_10_, float p_151541_12_, float p_151541_13_, float p_151541_14_, int p_151541_15_, int p_151541_16_, double p_151541_17_)
    {
        ...
        {
            double d6 = 12.0D + (double)(MathHelper.sin((float)p_151541_15_ * (float)Math.PI / (float)p_151541_16_) * p_151541_12_ * 1.0F);
    ...
    {
        int i1 = this.rand.nextInt(this.rand.nextInt(this.rand.nextInt(42) + 1) + 1);
        ...
        for (int j1 = 0; j1 < i1; ++j1)
        {
            ...
            double d1 = (double)this.rand.nextInt(245);
