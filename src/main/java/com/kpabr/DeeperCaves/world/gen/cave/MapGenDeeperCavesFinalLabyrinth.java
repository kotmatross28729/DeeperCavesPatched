...
public class MapGenDeeperCavesFinalLabyrinth extends MapGenBase
{
                                ...
                                if (d13 * d13 + d14 * d14 < 1.0D)
                                {
                                    for (int l3 = i2 - 1; l3 >= j4; --l3)
                                    {
                                        ...
                                        if (d12 > -0.7D && d13 * d13 + d12 * d12 + d14 * d14 < 1.0D)
                                        {
                                            ...
                                            if (isTopBlock(p_151541_5_, k3, k2, l3-1, j3, p_151541_3_, p_151541_4_))
                                            {
                                                flag1 = true;
                                            }
    ...
    protected void func_151538_a(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_, Block[] p_151538_6_)
    {
        ...
        for (int j1 = 0; j1 < i1; ++j1)
        {
            ...
            double d1 = (double)this.rand.nextInt(254);
