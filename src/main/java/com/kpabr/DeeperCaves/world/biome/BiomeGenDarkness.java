...
public class BiomeGenDarkness extends BiomeGenBase
{
    public WorldGenerator theWorldGenerator;

    public BiomeGenDarkness(int p_i45377_1_, int p_i45377_2_)
    {
        super(p_i45377_1_);
        ...
        this.fillerBlock = DeeperCaves.blocks.darkStone;
        this.rainfall = 0.68F;
