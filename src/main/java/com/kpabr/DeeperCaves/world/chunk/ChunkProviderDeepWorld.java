...
public class ChunkProviderDeepWorld extends ChunkProviderGenerate implements IChunkProvider
{
    /** RNG. */
        ...
        for (int k = 0; k < 16; ++k)
        {
            for (int l = 0; l < 16; ++l)
            {
                ...
                for (int l1 = 255; l1 >= 0; --l1)
                {
                    ...
                    if (l1 == 2)
                    {
                    	p_147422_3_[i2] = DeeperBlocks.compressedPortal;
                    }
                    if (l1 == 254)
                    {
                    	p_147422_3_[i2] = DeeperBlocks.mazePortal;
                    }
                    if (l1 >= 77)
                    {
