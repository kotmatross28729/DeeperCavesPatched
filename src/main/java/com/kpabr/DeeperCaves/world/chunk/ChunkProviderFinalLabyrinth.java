...
public class ChunkProviderFinalLabyrinth extends ChunkProviderGenerate implements IChunkProvider
{
    /** RNG. */
    ...
    private final MapGenBase ravineGenerator = new MapGenDeeperRavine();
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                    p_147424_3_[j3 += short1] = DeeperBlocks.fragmentedBedrock;
                                }
                                else if (k2 * 8 + l2 < b0)
                                {
                                    p_147424_3_[j3 += short1] = DeeperBlocks.fragmentedBedrock;
        ...
        for (int k = 0; k < 16; ++k)
        {
            for (int l = 0; l < 16; ++l)
            {
                ...
                for (int l1 = 255; l1 >= 0; --l1)
                {
                    ...
                    {
                    	p_147422_3_[i2] = DeeperBlocks.fragmentedBedrock;
                    }
