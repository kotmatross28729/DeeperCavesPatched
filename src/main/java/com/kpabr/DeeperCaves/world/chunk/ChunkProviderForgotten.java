...
public class ChunkProviderForgotten extends ChunkProviderGenerate implements IChunkProvider
{
    /** RNG. */
    ...
    private final MapGenBase caveGenerator2 = new MapGenDeeperCavesDarknessUpper();
