...
import com.kpabr.DeeperCaves.world.gen.cave.MapGenDeeperRavineMutation;
...
public class ChunkProviderMutation extends ChunkProviderGenerate implements IChunkProvider
{
    /** RNG. */
    ...
    private MapGenBase ravineGenerator = new MapGenDeeperRavineMutation();
