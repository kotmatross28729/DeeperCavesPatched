...
import com.kpabr.DeeperCaves.world.gen.cave.MapGenDeeperCavesFarVoid;
import com.kpabr.DeeperCaves.world.gen.cave.MapGenDeeperRavineFarVoid;
...
public class ChunkProviderFarVoid extends ChunkProviderGenerate implements IChunkProvider
{
    /** RNG. */
    ...
    private MapGenBase ravineGenerator = new MapGenDeeperRavineFarVoid();
    ...
    private static final String __NOOBFID = "CL_00000396";
    ...
    private void func_147423_a(int p_147423_1_, int p_147423_3_)
    {
        ...
        this.field_147427_d = this.field_147429_l.generateNoiseOctaves(this.field_147427_d, p_147423_1_, 0, p_147423_3_, 5, 33, 5, 8.555150000000001D, 4.277575000000001D, 8.555150000000001D);
        this.field_147428_e = this.field_147431_j.generateNoiseOctaves(this.field_147428_e, p_147423_1_, 0, p_147423_3_, 5, 33, 5, 684.412D, 684.412D, 684.412D);
        this.field_147425_f = this.field_147432_k.generateNoiseOctaves(this.field_147425_f, p_147423_1_, 0, p_147423_3_, 5, 33, 5, 684.412D, 684.412D, 684.412D);
        boolean flag1 = false;
        boolean flag = false;
        int l = 0;
        int i1 = 0;
