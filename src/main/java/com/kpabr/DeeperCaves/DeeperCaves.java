...
public class DeeperCaves
{
    ...
    //creative tabs
    static CreativeTabs tabDeeperCaves = new TabDeeperCavesBlocks(CreativeTabs.getNextID(), StatCollector.translateToLocal("tab.Deeper.Caves.Blocks"), DeeperCaves.blocks.fragmentedBedrock);
    static CreativeTabs tabDeeperCavesItems = new TabDeeperCaves(CreativeTabs.getNextID(), StatCollector.translateToLocal("tab.Deeper.Caves.Items"), 0);
    static CreativeTabs tabDeeperCavesOres = new TabDeeperCavesOres(CreativeTabs.getNextID(), StatCollector.translateToLocal("tab.Deeper.Caves.Ores"), DeeperCaves.blocks.dcdiamondOre);
    static CreativeTabs tabDeeperCavesTools = new TabDeeperCaves(CreativeTabs.getNextID(), StatCollector.translateToLocal("tab.Deeper.Caves.Tools"), 1);
